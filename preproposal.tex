...
\nn{The description should include a background of the topic, relationships with other parts of mathematics or other disciplines, goals and areas of potential progress, an outline of the proposed program's structure, proposed involvement of postdocs and interactions with other scientists, and why the proposal is particularly suited to MSRI. It is highly desirable that the program show the breadth of the mathematical field being treated, and take into special account its relation to other fields of mathematics and (in appropriate cases) other sciences and engineering.}
