...
For the introductory workshop, we suggest having one speaker for each of the 7 streams of the conference, each giving two talks.  The speakers will be chosen as the best expository speakers, able to give clear and motivated introductions to a broad audience. We will ask the speakers to talk about the background of their field as well as to give suggestions for open problems and future directions, to set the stage for the semester's work. We will ensure that the first day of the introductory workshop gives a broad introduction to the whole program, and assumes only a general mathematical background. In particular, the first day will begin with introductions to tensor categories, Hopf algebras, and topological phases of matter.
...
\end{itemize}
and closer to the date appropriate junior researchers may be invited. 
We will strongly emphasize to each of the speakers the importance of giving accessible and broadly interesting talks, and coordinate closely with them on the material to be covered.
