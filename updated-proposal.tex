...
For the updated proposal submitted December 2016, we have now asked some of the senior participants about the time they will be able to commit to attending the program.
\begin{description}
  \setlength{\itemsep}{1pt}
  \setlength{\parskip}{0pt}
  \setlength{\parsep}{0pt}
